...
Gerçek iki-site izolasyon, rotation/revoke, backup/restore, drop-preview ve browser kabulü `todo.md` T-DATABASE altındadır. Gerçek schema delete safety/compensation zinciri ayrı `plan.md` maddesi olarak açık kalır.
