...
- Database ekranı her normal GET/refresh'te yerel MySQL/MariaDB Unix socket'inden strict-sanitize edilmiş canlı envanter okur; günlük akış “sunucuyu tara” job'ına bağlı değildir. Create/drop/credential/backup/restore mutation'ları durable job, binding ve ownership kanıtı sınırında kalır. Shared phpMyAdmin/pgAdmin gateway henüz yoktur.
