...
- Provisioning child host job worker-anı live auth, gerçek iki OS process/lock crash-permission, write-failure/cold-restart ve Node24/npm11/host/browser kabulü hâlâ açıktır.
