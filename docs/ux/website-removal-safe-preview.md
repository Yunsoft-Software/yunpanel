...
- Worker anında live tenant auth gereken diğer host writer'lar, provisioning-reservation compensation recovery, gerçek iki OS process/lock crash-permission, write-failure/cold-restart ve Node24/npm11/host/browser kabulü hâlâ açıktır.
