...
- [x] Cron worker live auth: `d0704aa4` → `49512a45`; user cron jobs actor session/user/role pinler ve local worker host mutation öncesi live session/MFA/Website grant recheck yapar. Website-removal cron jobs explicit `system_removal`; apply için kullanılamaz. `51375637`, `b5263cf5`, `e765441f`, `f49b1d7b` test kaynağı.
