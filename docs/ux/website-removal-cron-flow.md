...
- [ ] RC-01: Cron silme isteğinde queued/accepted ile removed ayrımını düzelt. Host sonucu doğru görev/özetle doğrulanmadan ve metadata kaldırılmadan başarı üretilmesin.
...
Dosya/Unix temizliği, bütün Website yazıcılarının ortak kilidi, çalışmaya başlamış cron süreçlerinin durması, tenant yetkisinin worker anında doğrulanması ve gerçek host kabulü ayrı açık kalır. Bir zamanlayıcı dosyasının kaldırılması önceden başlamış işi durdurduğu anlamına gelmez. Yedek/retention ve başka siteye dokunmama şartları kaldırılmaz.
...
- [ ] Gerçek site silme ekranında queued/blocked/failed/complete ayrımı, mevcut işe dönüş ve kontrollü devam; eksik file/Unix adaptörüyle site silme hâlâ blokeli kalmalı.
