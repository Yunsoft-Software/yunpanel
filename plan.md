...
- [ ] Staged shared phpMyAdmin FPM/Nginx bundle'ını packaged dedicated runtime identity + private temp/session dizinleri üzerinde durable validate/activate/rollback akışına bağla; Unix gateway socket ownership/mode ve endpoint health'ini kanıtla.
