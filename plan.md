...
- [ ] Full email + password Dovecot IMAP login ve authenticated Postfix submission gerçek-host kabulünü tamamla; Dovecot auth/passdb SQL, static vmail userdb, Postfix submission 587/465 Dovecot SASL soketi, Roundcube %u/%p TLS endpoint konfigürasyonu ve 5'li protokol sağlık denetimi kaynak kodda hazırdır; gerçek Ubuntu teslim ve oturum kabulü `todo.md` içindedir.
