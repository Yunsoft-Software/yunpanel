...
- [ ] Mailbox quota/usage ve gerçek mailbox forwarding lifecycle ekle.
...
- [ ] Bu baseline sonrasındaki managed-mail apply/recovery, empty-set teardown, alias lifecycle/config/recovery ve HTTP/production wiring değişiklikleri için targeted config-templates + host-runtime + API testlerini ve ardından güncel `main` full Node 24 lint/build/test kontrolünü yeniden çalıştır.
...
2. Mail lifecycle'ın kalan quota/forwarding/diagnostic/Roundcube/data parçaları ve gerçek servis kabulü.
