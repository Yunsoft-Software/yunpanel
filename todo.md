...
- [ ] En az bir gerçek Website identity ownership receipt fixture'ı bulunan test hostunda package upgrade'i tekrarla; `/var/lib/yunpanel/staging/website-identities` root:root `0700`, receipt dosyaları root:root `0600` ve içerik hash'leri upgrade boyunca korunsun.
