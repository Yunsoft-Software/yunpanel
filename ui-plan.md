...
- [x] Reseller hesap kapsamı + **Müşterilerim** kaynak dilimi: `232d119e` → `9b496d2f`; server-derived persisted reseller context, direct-customer list/status, reseller-only customer login/profile create, username/parola edit ve `/customers` ekranı. Owner ve sıradan site-manager menüsü değişmez; create/edit `siteAccessGranted:false` doğrular. [Kaynak raporu](docs/history/reseller-customer-management-2026-09-26.md). Yeni testler bu oturumda çalıştırılmadı.
