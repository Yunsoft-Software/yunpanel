...
const SERVICE_CATALOG = Object.freeze([
  ...
  service({
    ...
    label: 'elFinder',
    category: 'file_tool',
    packages: ['php-fpm', 'php-mbstring', 'php-zip', 'libjs-jquery', 'libjs-jquery-ui'],
    units: [],
    configurationChecks: [
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/VERSION'] },
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/index.html'] },
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/yunpanel-client.js'] },
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/vendor/elfinder/js/elfinder.min.js'] },
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/vendor/elfinder/css/elfinder.min.css'] },
      { file: '/usr/bin/test', args: ['-f', '/usr/share/yunpanel/elfinder/vendor/elfinder/img/toolbar.png'] },
      ...
      { file: '/usr/bin/test', args: ['-f', '/usr/share/javascript/jquery/jquery.min.js'] },
