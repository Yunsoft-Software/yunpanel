...
import {removalBlockerLabel,removalState,resolveRemovalAccess} from '../src/workspace/website-removal-model.js';
...
const bucket={status:'available',ids:[]};
const preview={version:1,operation:'website_remove',website:{id:scope.websiteId,name:'Example',serverId:scope.serverId,applicationId:'33333333-3333-4333-8333-333333333333',systemUser:'yunapp-123456789abc'},impact:{},plan:{domains:[],activeJobIds:[],additional:{databases:bucket,sftpKeys:bucket,runtimeBindings:bucket,unixIdentities:bucket,logScopes:bucket,crons:bucket,backups:bucket}},hardBlockers:['application_cleanup_unavailable'],readyToStart:false,previewDigest:'a'.repeat(64),confirmation:null,sideEffects:false};
