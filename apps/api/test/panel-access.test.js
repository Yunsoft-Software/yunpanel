...
test('read-only inventory rules are exact and exclude nested sensitive GETs', () => {
  ...
  for (const path of ['/api/jobs', '/api/users', '/api/applications/app-1/environment', '/api/applications/app-1/status', '/api/dev/servers', '/api/servers/server-1/system/packages/inspect']) {
