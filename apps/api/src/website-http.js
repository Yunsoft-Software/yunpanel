...
const CREATE_FIELDS = new Set(['serverId', 'name', 'applicationId', 'runtimeType', 'proxyTarget']);
const UPDATE_CHANGE_FIELDS = new Set(['name', 'applicationId', 'runtimeType', 'proxyTarget']);
